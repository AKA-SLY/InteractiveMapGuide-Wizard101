      ...
      <header className="top-bar">
        <div className="top-bar__lede">
          ...
          <p className="lede">
            ...
            feed directly into the catalog. Use the chips to jump into the original HTML links or
            browse the image library as you explore the spells, quests, and furniture tabs.
          </p>
          ...
          <div className="actions">
            ...
            <a
              className="chip-link chip-link--inline"
              href="https://wiki.wizard101central.com/wiki/Category:Items"
              target="_blank"
              rel="noreferrer"
            >
              Wizard101Central items
            </a>
            <a
              className="chip-link chip-link--inline"
              href="https://wiki.wizard101central.com/wiki/Category:Quests"
              target="_blank"
              rel="noreferrer"
            >
              Wizard101Central quests
            </a>
          </div>
        </div>
        ...
        <div className="top-bar__actions">
          <div className="data-stats">
            <article className="data-stats__card">
              ...
              <p className="hint">Parsed from the <code>html&apos;s/Quests</code> folder; tap a chip to open the source.</p>
              <div className="chip-row">
                {questSourceSamples.map((quest) => (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    title={`Open ${quest.name} on Wizard101Central`}
                  >
                    {quest.name}
                  </a>
                ))}
